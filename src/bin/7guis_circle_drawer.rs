...
mod circle {
    ...
    use iced_native::mouse::click::Click;
...
impl Sandbox for Example {
    ...
    fn new() -> Self {
        ...
        vec.push(50.0);
        vec.push(50.0);
        Example { radius: vec, selection: 0 }
    }
    ...
    fn update(&mut self, message: Message) {
        match message {
            Message::RadiusChanged(radius) => {
                self.radius[self.selection] = radius;
            }
    ...
    fn view(&self) -> Element<Message> {
        ...
        let content = column![
            circle(self.radius[0]),
            circle(self.radius[1]),
            text(format!("Radius: {:.2}", self.radius[self.selection])),
            slider(1.0..=100.0, self.radius[self.selection], Message::RadiusChanged).step(0.01),
        ]
        .padding(20)
        .spacing(20)
        .max_width(500)
